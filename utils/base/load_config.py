    ...
    def _parse_referral_codes(self) -> List[str]:
        try:
            ...
            for code in referral_codes:
                ...
                elif code.startswith("https://dashboard.3dos.io/register?ref_code="):
                    code = code.split("ref_code=")[1]
    ...
    def load(self) -> Config:
        try:
            ...
            if not referral_codes:
                raise ConfigurationError("No referral codes found in referral_codes.txt | Registration without referral codes is prohibited by the 3Dos itself")
